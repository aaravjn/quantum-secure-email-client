...
def encrypt(message, reciever_kyber_public_key):
    ...
    concetanated_string = json.dumps({
        ...
        'encrypted_passkey': str(base64.b64encode(encrypted_aes_shared_passkey), encoding='utf-8')
    })
...
def decrypt(tag, concetanated_string, username):
    ...
    # Decrypt the passkey
    passkey = Kyber512.dec(base64.b64decode(encrypted_passkey), base64.b64decode(reciever_private_key))
