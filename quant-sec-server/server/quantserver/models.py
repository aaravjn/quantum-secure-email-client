...
class Emails(models.Model):
    sender = models.ForeignKey("Users", on_delete=models.CASCADE, related_name="wrote", to_field='username')
    reciever = models.ForeignKey("Users", on_delete=models.CASCADE, related_name="recieved", to_field='username')
